...
public:
    ...
    static void window_threshold(cv::Mat image, cv::Mat &thresholded, cv::Mat mask, cv::Size window_size, double threshod_scale);
    ...
    static uchar get_average(cv::Mat image, cv::Mat mask);
